...
\title[Development of DNA sequence\\classifiers based on deep learning]{Development of DNA sequence classifiers based on deep learning}
...
\authorname[m]{João Nuno Cardoso Gonçalves de Abreu}{João Abreu}
...
% use [f] for female and [m] for male
\adviser[m]{Miguel Rocha}{Full Professor}{\\& University of Minho} 
...
% use [f] for female and [m] for male
\coadviser[f]{Óscar Dias}{Associate\\& Professor}{University of Minho}
...
\chapterfile{2_ml_dl}
\chapterfile{3_dna_sequence_classification}
% \chapterfile{5_research_plan}
\chapterfile{6_Dev}
\chapterfile{7_Integration}
\chapterfile{8_Validation}
\chapterfile{9_Future_Work_and_Conclusions}
...
% atory  % Print the dedicatory (will only be printed if adequate for the document type)
